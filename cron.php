...
Это означает что с сайта всё  загружено – нечего больше обрабатывать</p>
        ...
        <p>Ошибки типа <strong>QUERY ERROR:</strong>&nbsp;MySQL server has gone away - не ошибки скриптов программы - это проблемы с хостингом - обращайтесь в техподдержку хостера</p>
        <p>Ошибки типа <b>404 Not Found</b> - не ошибки скриптов программы - это проблемы с хостингом - обращайтесь в техподдержку хостера</p>
